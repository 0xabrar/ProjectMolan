...
class FGMembersite
{
    ...
    function RegisterUser()
    {
        ...
        //TODO implement mailserver to add in user confirmation emails
        /*
    ...
    function ValidateRegistrationSubmission()
    {
        ...
        {
            //The proper error is not given intentionally for spam bot
    ...
    function CollectRegistrationSubmission(&$formvars)
    {
        ...
        $formvars['password'] = $this->Sanitize($_POST['password1']);
        $formvars['gender'] = $this->Sanitize($_POST['gender']);
        $formvars['email'] = $this->Sanitize($_POST['email']);
        $formvars['province'] = $this->Sanitize($_POST['province']);
        $formvars['postal'] = $this->Sanitize($_POST['postal']);
        
        //Seperate steps are taken to turn the birthday into a single string. 
        $year = $this->Sanitize((string)$_POST['year']);
        $month = $this->Sanitize((string)$_POST['month']);
        $day = $this->Sanitize((string)$_POST['day']);
        $birthday = $year . "-" . $month . "-" . $day; //This ensures YYYY-MM-DD format for MySQL.
        $formvars['birthday'] = $birthday;
